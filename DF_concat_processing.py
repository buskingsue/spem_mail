...
#================================================================
df1 = pd.read_csv('./model/1.bill_last.csv')
df2 = pd.read_csv('./model/2.info_last.csv')
df3 = pd.read_csv('./model/3.promotion_ad_last_last.csv')
df4 = pd.read_csv('./model/4.social_business_last.csv')

df_1= pd.concat([df1,df2])
df_2= pd.concat([df_1,df3])
df_3= pd.concat([df_2,df4])

df_3.to_csv('./model/data_lastest2.csv', index=False)